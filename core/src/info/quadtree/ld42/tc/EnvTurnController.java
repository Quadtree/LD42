...
public class EnvTurnController extends TurnController {
    ...
    public void turnStart() {
        ...
        if (falling > 0){
            ...
            Util.showTutorialText("Uh oh, looks like those shaking hexes were a bit unstable! Luckily, this ground base is remotely operated... and insured. Press V to see when more will collapse.");
        }
    }
